            ...
            {ROW_1_ITEMS.map((tech, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="text-[#34154E] dark:text-[#F5F3FA] group-hover:text-[#583C7E] dark:group-hover:text-[#C4B5FD] transition-colors">
                    <Icon className="w-8 h-8 sm:w-9 sm:h-9" />
                  </div>

                  {/* Technology Name */}
                  <span className="font-sora text-[12px] sm:text-[13px] font-medium tracking-tight text-[#583C7E]/85 dark:text-[#A099AD] group-hover:text-[#34154E] dark:group-hover:text-white transition-colors text-center">
                    {tech.name}
                  </span>
                </div>
              );
